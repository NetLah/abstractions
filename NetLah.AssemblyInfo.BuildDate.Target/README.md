...
<ItemGroup>
  ...
  <PackageReference Include="NetLah.AssemblyInfo.BuildDate.Target" Version="0.2.0" PrivateAssets="All" />
</ItemGroup>
```
...
<ItemGroup>
  ...
  <PackageReference Update="NetLah.AssemblyInfo.BuildDate.Target" Version="0.2.0" PrivateAssets="All" />
</ItemGroup>
```
