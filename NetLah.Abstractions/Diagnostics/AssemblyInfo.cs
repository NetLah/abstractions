...
public class AssemblyInfo : IAssemblyInfo
{
    ...
    public AssemblyInfo(Assembly assembly)
    {
        ...
        _buildDate = new Lazy<DateTimeOffset?>(
            () => BuildDateHelper.ParseBuildDate(_assembly.GetCustomAttributes<AssemblyMetadataAttribute>()) ??
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    public DateTimeOffset? BuildTime => _buildDate.Value;
