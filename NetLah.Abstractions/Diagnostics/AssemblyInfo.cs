...
namespace NetLah.Diagnostics
{
    public class AssemblyInfo : IAssemblyInfo
    {
        ...
        public AssemblyInfo(Assembly assembly)
        {
            ...
            _informationalVersion = new Lazy<string>(() => _assembly.GetCustomAttribute<AssemblyInformationalVersionAttribute>()?.InformationalVersion);
            _product = new Lazy<string>(() => _assembly.GetCustomAttribute<AssemblyProductAttribute>()?.Product);
            _title = new Lazy<string>(() => _assembly.GetCustomAttribute<AssemblyTitleAttribute>()?.Title);
