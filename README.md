...
[NetLah.AssemblyInfo.BuildDate.Target](https://www.nuget.org/packages/NetLah.AssemblyInfo.BuildDate.Target/) is MSBuild target for assembly build-time generation.
...
[![NuGet](https://img.shields.io/nuget/v/NetLah.AssemblyInfo.BuildDate.Target.svg?style=flat-square&label=nuget&colorB=00b200)](https://www.nuget.org/packages/NetLah.AssemblyInfo.BuildDate.Target/)

Package rename:
- Current Nuget package name [NetLah.AssemblyInfo.BuildDate.Target](https://www.nuget.org/packages/NetLah.AssemblyInfo.BuildDate.Target)
- Previous Nuget package name (from 2023 to 2025): NetLah.AssemblyInfo.BuildTime.Target
...
<ItemGroup>
  ...
  <PackageReference Include="NetLah.AssemblyInfo.BuildDate.Target" Version="1.0.0" PrivateAssets="All" />
</ItemGroup>
```
...
Copyright (C) Microsoft Corporation. All rights reserved.
  ...
  SampleApp [BuildDate] := 2021-11-08T21:26:28 (net6.0)
...
Version:0.2.0-rc2.2 BuildDate:2021-11-08T21:26:28+08:00; Framework:.NETStandard,Version=v2.0
```
...
Console.WriteLine($"Version:{appInfo.InformationalVersion} BuildDate:{appInfo.BuildTimestampLocal};Framework:{appInfo.FrameworkName}");
```
...
```text
AppTitle:SampleApp
Version:0.2.0-rc2.2 BuildDate:2021-11-08T21:26:56+08:00; Framework:.NETCoreApp,Version=v6.0
```

### 4. Use `Directory.Build.targets` to declare build date time attribute to all projects inside the solution

- Set build date time to projects that already include packageReference `NetLah.AssemblyInfo.BuildDate.Target`

```xml
<ItemGroup>
  <PackageReference Update="NetLah.Abstractions" Version="1.0.0" />
  <PackageReference Update="NetLah.AssemblyInfo.BuildDate.Target" Version="1.0.0" PrivateAssets="All" />
</ItemGroup>
```
